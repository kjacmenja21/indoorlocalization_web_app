...
export const AuthService = {
    ...
    getCurrentUser: () => {
        try {
            ...
            console.error('Error retrieving current user from localStorage:', error.message);
            return null;
        }
    },
    ...
    refreshToken: async () => {
        try {
            ...
            const response = await axiosInstance.post(API_PATHS.REFRESH_TOKEN, { refreshToken });
